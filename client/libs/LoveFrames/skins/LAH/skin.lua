...
skin.name = "LAH"
skin.author = "shakesoda"
skin.version = "0.01"

local smallfont = love.graphics.newFont("assets/fonts/OpenSans-Regular.ttf", 14)
local mediumfont = love.graphics.newFont("assets/fonts/OpenSans-Semibold.ttf", 14)
local imagebuttonfont = love.graphics.newFont("assets/fonts/OpenSans-Regular.ttf", 16)
...
skin.controls.frame_name_color                      = {50, 50, 50, 255}
skin.controls.frame_name_font                       = mediumfont

-- button
skin.controls.button_text_down_color                = {0, 0, 0, 255}
skin.controls.button_text_nohover_color             = {0, 0, 0, 200}
skin.controls.button_text_hover_color               = {0, 0, 0, 255}
skin.controls.button_text_nonclickable_color        = {0, 0, 0, 100}
skin.controls.button_text_font                      = smallfont

-- imagebutton
skin.controls.imagebutton_text_down_color           = {0, 0, 0, 255}
skin.controls.imagebutton_text_nohover_color        = {255, 255, 255, 200}
skin.controls.imagebutton_text_hover_color          = {0, 0, 0, 255}
...
skin.controls.closebutton_body_hover_color          = {0, 0, 0, 255}
...
skin.controls.tab_text_hover_color                  = {0, 0, 0, 255}
...
skin.controls.multichoicerow_text_hover_color       = {0, 0, 0, 255}
...
-- columnlistheader
skin.controls.columnlistheader_text_down_color      = {0, 0, 0, 255}
skin.controls.columnlistheader_text_nohover_color   = {0, 0, 0, 200}
skin.controls.columnlistheader_text_hover_color     = {0, 0, 0, 255}
...
skin.controls.columnlistrow_text_hover_color        = {0, 0, 0, 255}
...
skin.controls.menuoption_text_hover_color           = {0, 0, 0, 255}
...
function skin.DrawFrame(object)
	...
	love.graphics.rectangle("fill", x - 1, y, width + 2, height + 2)
	...
	if icon then
		...
		love.graphics.print(name, x + iconwidth + 10, y + 8)
	else
		love.graphics.setColor(namecolor)
		love.graphics.print(name, x + 8, y + 8)
	end
	
	love.graphics.setColor(220, 220, 220, 255)
	skin.OutlinedRectangle(x + 1, y + 35, width - 2, height - 36)
...
function skin.DrawButton(object)
	...
	if down then
		...
		-- button body
		love.graphics.setColor(255, 255, 255, 255)
		love.graphics.draw(image, x, y + 2, 0, width, scaley)
		-- button text
		love.graphics.setFont(font)
